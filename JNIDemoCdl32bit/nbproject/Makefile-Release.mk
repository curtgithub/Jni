...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libJNIDemoCdl32bit.${CND_DLIB_EXT}: ${OBJECTFILES}
	...
	${LINK.c} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libJNIDemoCdl32bit.${CND_DLIB_EXT} ${OBJECTFILES} ${LDLIBSOPTIONS} -shared

${OBJECTDIR}/src/HelloWorld.o: src/HelloWorld.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -O2  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/HelloWorld.o src/HelloWorld.c

${OBJECTDIR}/src/JNIDemo.o: src/JNIDemo.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -O2  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/JNIDemo.o src/JNIDemo.c

${OBJECTDIR}/src/JNIDemoJava.o: src/JNIDemoJava.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -O2  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/JNIDemoJava.o src/JNIDemoJava.c

${OBJECTDIR}/src/PassStringJtoC.o: src/PassStringJtoC.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -O2  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/PassStringJtoC.o src/PassStringJtoC.c
